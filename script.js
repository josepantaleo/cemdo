document.addEventListener("DOMContentLoaded", () => {
    ...
    function actualizarTextos() {
        ...
        const elementosParaTraducir = [
            ...
            // Paragraphs
            { selector: '#calculadoraDescripcion', text: t.calculatorDescription },
            { selector: '#triviaDescripcion', text: t.triviaDescription },
            { selector: '#simuladorDescripcion', text: t.simulatorDescription },
            ...
            { selector: '#video-beneficios .video-caption', text: t.videoCaption },
    ...
    // Cargar la preferencia del tema al iniciar y actualizar el texto del botón
    const temaGuardado = localStorage.getItem("theme");
    if (temaGuardado === "dark") {
        document.body.classList.add("modo-oscuro");
    }
    // Establecer el texto inicial del botón de tema
